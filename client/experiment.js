...
addEventListener("load", function () {
    ...
    var boxA = Bodies.rectangle(0, 0, 50, 10, {
        //collisionFilter: { group: -1 },
        //isStatic: true
    });
    var boxB = Bodies.rectangle(0, 0, 80, 80, {
        //collisionFilter: { group: -1 },
        //isStatic: true
    });
    ...
    Body.setPosition(boxA, compoundBody.position);
    ...
    */
    ...
    Composite.add(engine.world, [ground, compoundBody]);
